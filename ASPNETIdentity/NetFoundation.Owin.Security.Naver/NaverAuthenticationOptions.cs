...
namespace NetFoundation.Owin.Security.Naver
{
    ...
    public class NaverAuthenticationOptions : AuthenticationOptions
    {
        ...
        /// <summary>
        ///     Gets or sets the Naver supplied Client ID
        /// </summary>
        public string ClientId { get; set; }

        /// <summary>
        ///     Gets or sets the Naver supplied Client Secret
        /// </summary>
        public string ClientSecret { get; set; }

        /// <summary>
        ///     Gets or sets the <see cref="INaverAuthenticationProvider" /> used in the authentication events
        /// </summary>
        ...
        /// </summary>
        public NaverAuthenticationOptions() : base("Naver")
        {
